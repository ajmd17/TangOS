...
ghost-i686-elf-tools\bin\i686-elf-g++.exe -Isysroot/include/ -c src/kernel/idt.c -o obj/idt.o -ffreestanding -O2 -Wall -Wextra
ghost-i686-elf-tools\bin\i686-elf-g++.exe -Isysroot/include/ -c src/kernel/irq.c -o obj/irq.o -ffreestanding -O2 -Wall -Wextra
ghost-i686-elf-tools\bin\i686-elf-g++.exe -Isysroot/include/ -c src/kernel/gdt.c -o obj/gdt.o -ffreestanding -O2 -Wall -Wextra
ghost-i686-elf-tools\bin\i686-elf-g++.exe -Isysroot/include/ -c src/kernel/isrs.c -o obj/isrs.o -ffreestanding -O2 -Wall -Wextra
